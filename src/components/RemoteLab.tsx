...
import {
  AlertTriangle, ArrowDown, ArrowLeft, ArrowUp, Clock, Droplet, Flame, Microscope, OctagonX, Play, RotateCw, Square, Star, Thermometer, Zap
} from 'lucide-react';
        ...
        <div className="mx-auto px-3 py-4">
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              {/* Stage Indicator */}
              <div className="bg-gradient-to-r from-green-500 to-blue-500 text-white rounded-xl p-3 mb-4 shadow-lg">
              ...
              {/* Process Overview */}
              <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl p-3 shadow-xl">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="flex items-center gap-2 text-white">
                    ...
                    <div className="flex items-center w-20 gap-2 px-3 py-1.5 rounded-lg bg-orange-500">
                ...
                <div className="flex items-center justify-around py-8">
                  ...
                  <div className="relative">
                    ...
                    <div className={`absolute -top-10 left-1/2 -translate-x-1/2 px-3 py-1.5 rounded-lg flex items-center gap-2 ${
                      ...
                      <Zap className={`w-4 h-4 ${reactorAgitador ? 'text-white' : 'text-gray-400'}`} />
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm">
                ...
                <div className="mb-4 p-3 bg-blue-50 rounded-lg">
                  <p className="text-sm text-gray-700">
                    ...
                    <span className={`ml-1 font-bold ${supplyLevelWarning ? 'text-red-600' : 'text-green-600'}`}>
                      {supplyTankLevel.toFixed(1)}L
                    </span>
                    {supplyLevelWarning && (
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm">
                ...
                <div className="space-y-4 mb-4">
                  <div>
                    ...
                    <input type="number" value={targetTemp} disabled={!isRunning} min="0" max={REACTOR_TEMP_MAX}
                  ...
                  <div>
                    ...
                    <input type="number" value={targetRPM} disabled={!isRunning} min="0" max={REACTOR_RPM_MAX}
                ...
                <div className="space-y-4">
                  ...
                  <div className={`p-4 rounded-lg ${rpmWarning ? 'bg-red-50 border-2 border-red-200' : 'bg-gray-50'}`}>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-xl font-bold text-gray-900">{Math.round(agitadorRPM)}</span>
                    </div>
